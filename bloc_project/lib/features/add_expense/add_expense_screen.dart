...
class AddExpenseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ExpensesBloc()..add(StartAddExpense(userId)),
      child: BlocConsumer<ExpensesBloc, ExpensesState>(
        ...
        builder: (context, state) {
          ...
          // Fixed category options (single select)
          const categories = [
            'Food',
            'Transportation',
            'Bills',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ValueListenableBuilder(
                            valueListenable: bloc.categoryCtrl,
